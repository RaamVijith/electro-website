...
const products = [
  ...
  },
  {
    ...
    price: 789.00,
    image:"https://electro.madrasthemes.com/3x/wp-content/uploads/sites/4/2023/11/Mobile-4.png",
...
const TrendingProducts = () => {
  const [activeTab, setActiveTab] = useState('Trending Products This Week');
  ...
  return (
    <div className="mx-4 md:mx-8 lg:mx-[5vw] p-4 md:p-[3%] bg-white rounded-3xl mt-4 md:mt-[8vh]">
      ...
      <div className="flex gap-4 border-b border-gray-200 mb-8">
        {['Trending Products This Week'].map((tab) => (
          <button
            key={tab}
